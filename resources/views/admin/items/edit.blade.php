    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.items.index') }}">Menu Items</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit</li>
            </ol>
        </nav>
        <h1 class="h3 m-0 fw-bold text-white">Edit Menu Item</h1>
    </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-100">
                            <label class="form-label fw-semibold small text-white-50">Item Name <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $item->name) }}" placeholder="e.g., Spicy Tuna Crispy Rice" required>
                            @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <!-- Category Selector Module -->
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-white-50">Category <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold small text-white-50">Base Price ($) <span class="text-danger">*</span></label>
                        ...
                        <div class="col-100">
                            <label class="form-label fw-semibold small text-white-50">Description</label>
                            <textarea name="description" class="form-control" rows="4" placeholder="Describe this menu item's ingredients, allergens, or special preparations...">{{ old('description', $item->description) }}</textarea>
                        </div>
            ...
            <div class="d-flex flex-column gap-4">
                        ...
                        @if($item->image)
                            <div class="position-relative mb-3 mx-auto overflow-hidden d-inline-block" style="border-radius: 12px; border: 1px solid var(--admin-border); max-width: 100%;">
                                ...
                                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center opacity-0 hover-overlay style-hint" style="background: rgba(0,0,0,0.6); transition: all 0.2s ease;">
                                    <span class="badge bg-dark border border-secondary text-white">Current Asset</span>
                                </div>
                            </div>
                        @else
                            <div class="mb-3 py-4 text-center border border-dashed rounded-3 border-opacity-20 border-white" style="background: rgba(255,255,255,0.01);">
                                ...
                                <p class="small text-muted mt-2 mb-0">No image associated yet</p>
                            </div>
                        @endif
                        
                        <div class="text-start">
                            <label class="form-label fw-semibold small text-white-50">Upload Replacement Image</label>
                            <input type="file" name="image" class="form-control" accept="image/*">
                            <div class="form-text text-muted small mt-1" style="font-size: 0.75rem;">Supports JPEG, PNG, or WEBP formats.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-column gap-3 mb-4 border-bottom border-secondary border-opacity-10 pb-3">
                            <div class="form-check form-switch p-0 d-flex align-items-center justify-content-between">
                                <label class="form-check-label fw-medium text-white ms-0" for="is_available">
                                    Available for Order
                                    <span class="d-block text-muted" style="font-size: 0.75rem; font-weight: 400;">Show this item instantly across live customer menus</span>
                                </label>
                            ...
                            <div class="form-check form-switch p-0 d-flex align-items-center justify-content-between">
                                <label class="form-check-label fw-medium text-white ms-0" for="is_featured">
                                    ...
                                    <span class="d-block text-muted" style="font-size: 0.75rem; font-weight: 400;">Pin to prominent promo carousels at home-page sections</span>
                                </label>
                        ...
                        <div>
                            <label class="form-label fw-semibold small text-white-50">Menu Display Sorting Index</label>
                            ...
                            <div class="form-text text-muted small mt-1" style="font-size: 0.75rem;">Lower indices priority display sequence values pull sorting priorities forward.</div>
                        </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-admin-primary py-2.5">
                        <i class="bi bi-cloud-check-fill me-1"></i> Commit Configuration Save
                    </button>
